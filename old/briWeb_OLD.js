...
function fmp_AppendWork(whereToAppend, whichToAppend){
	...
	// FOR SOME REASON, SELECTIONS WITH ONLY 1 STARTS ON ZERO,
	// AND SLEECTIONS WITH MULTIPLE PIECES START ON 1
...
function createResume () {
	...
	doc.write('<html><head><title>Brian McLendon\'s 2016 Resume</title><link rel="stylesheet" type="text/css" href="briWeb.css"></head><body>');
	win.focus();
	...
	title.innerHTML = "Brian McLendon";
	title.className = "resumeTitle";
	doc.body.appendChild(title);

	doc.body.className = "resumeBody";

	//add contact info
	var contactInfo_holder = doc.createElement('div');
		contactInfo_holder.className = "resumeContact";
		doc.body.appendChild(contactInfo_holder);
	var contactInfo_UL = doc.createElement('ul');
		contactInfo_holder.appendChild(contactInfo_UL);
	var phone = doc.createElement('li');
		phone.innerHTML = "609-213-3356 &nbsp";
		contactInfo_UL.appendChild(phone);
	var email = doc.createElement('li');
		email.innerHTML = "mclendon.brian@gmail.com &nbsp";
		contactInfo_UL.appendChild(email);
	var website = doc.createElement('li');
		website.innerHTML = "brianmclendon.com";
		contactInfo_UL.appendChild(website);
	//add small bio
	var smallBio = doc.createElement('div');
	smallBio.className = "resumeBio";
	smallBio.innerHTML = 
	"Artist with a lifelong passion for the arts and technology. Excellent and diligent creator of concise and interactive media applications from mockup to rollout. Looking to build top notch user experiences."
	+"<br><br>Adobe Creative Suite, Adobe Script, APIs, Bootstrap, CLI, C#, CSS3, Firebase, Github, Graphic Design, HTML5, JavaScript, jQuery, JS node, Logic Pro, Media Queries, Photography, Unity3D";
	doc.body.appendChild(smallBio);
	// add education
	var education_holder = doc.createElement('div');
		education_holder.className = "education";
		doc.body.appendChild(education_holder);
	var education_UL = doc.createElement('ul');
		education_holder.appendChild(education_UL);
	var ED_title = doc.createElement('li');
		ED_title.innerHTML = "education";
		education_UL.appendChild(ED_title);
	var ED_1 = doc.createElement('li');
		ED_1.innerHTML = "<b>2017 / Rutgers University</b><br>Javascript Full Stack Certificate";
		education_UL.appendChild(ED_1);
	var ED_2 = doc.createElement('li');
		ED_2.innerHTML = "<b>2007 - 2009 / Rowan University</b><br>Bachelor of Arts in Graphic Design";
		education_UL.appendChild(ED_2);
	var ED_3 = doc.createElement('li');
		ED_3.innerHTML = "<b>2005 - 2007 / Fashion Institute of Technology</b><br>Associates in Communication Design";
		education_UL.appendChild(ED_3);
	// add work experiences
	var work_holder = doc.createElement('div');
		work_holder.className = "work";
		doc.body.appendChild(work_holder);
	var work_UL = doc.createElement('ul');
		work_holder.appendChild(work_UL);
	var work_title = doc.createElement('li');
		work_title.innerHTML = "work";
		work_UL.appendChild(work_title);
	var work_1 = doc.createElement('li');
		work_1.innerHTML = "<b>July 2017 - Present / Rutgers Coding Bootcamp</b><br>Teaching Assistant";
		work_UL.appendChild(work_1);
	var work_1 = doc.createElement('li');
		work_1.innerHTML = "<b>April 2016 - October 2016 / Franklin Machine Products</b><br>Graphic Designer and Product Photographer";
		work_UL.appendChild(work_1);
	var work_2 = doc.createElement('li');
		work_2.innerHTML = "<b>September 2015 - April 2016 / We Love Photobooths</b><br>Live Event Technician and Utility";
		work_UL.appendChild(work_2);
	var work_3 = doc.createElement('li');
		work_3.innerHTML = "<b>June 2013 - Present / Freelance and Part Time</b><br>Web, Graphic, and Interactive Design";
		work_UL.appendChild(work_3);
	var work_4 = doc.createElement('li');
		work_4.innerHTML = "<b>March 2013 - April 2013 / The Comcast Network</b><br>Broadcast Graphics | Network Graphics HD Rebuild";
		work_UL.appendChild(work_4);
	var work_5 = doc.createElement('li');
		work_5.innerHTML = "<b>October 2011 - February 2012 / G.Girl</b><br>Illustration | Graphic Design | Pre-Press Setup";
		work_UL.appendChild(work_5);
	var work_6 = doc.createElement('li');
		work_6.innerHTML = "<b>February - August 2010 / Village Copier</b><br>Signage | Advertisement | Pre-Press Setup | Retail Sales | Programming";
		work_UL.appendChild(work_6);
	var work_7 = doc.createElement('li');
		work_7.innerHTML = "<b>2008 - 2011 / The Comcast Network</b><br>Broadcast Graphics | Network Graphics HD rebuild | Live Event Production Utility";
		work_UL.appendChild(work_7);
}
